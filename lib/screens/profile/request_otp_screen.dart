        ...
        child: Column(
          ...
          children: [
              ...
              TextSpan(
                ...
                children: [
                  TextSpan(
                    ...
                    style: AppTextStyles.body3(fontWeight: FontWeight.w700),
                  ),
                  TextSpan(
            ...
            ElevatedButtonWidget(
              ...
              onPressed: () async {
                final res = await UserApi.postRequestOtp(email: userState.user!.email);
                if (res.data == true) {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => ChangePasswordScreen(email: userState.user!.email),
                    ),
                  );
                }
              },
