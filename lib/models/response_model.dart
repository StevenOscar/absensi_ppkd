...
class Errors {
  ...
  factory Errors.fromJson(Map<String, dynamic> json) => Errors(
    ...
    trainingId:
        json["training_id"] == null ? [] : List<String>.from(json["training_id"].map((x) => x)),
    batchId:
        json["batch_id"] == null ? [] : List<String>.from(json["batch_id"].map((x) => x)),
  );
  ...
  List<String> toList() {
    ...
    if (batchId?.isNotEmpty ?? false) errorMessages.add(batchId!.first);
    if (trainingId?.isNotEmpty ?? false) errorMessages.add(trainingId!.first);
